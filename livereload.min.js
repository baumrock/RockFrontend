...
let cnt=localStorage.getItem("livereload-count")||0;localStorage.setItem("livereload-count",++cnt);console.log("detected change - reloading "+cnt);reloading=!0;setTimeout(()=>{document.location.reload(!0)},redirecttimeout)};evtSource.onerror=function(event){console.log("Error occurred in EventSource, reloading window.");setTimeout(()=>{window.location.reload()},1500)}};startStream();console.log("RockFrontend is listening for file changes...")},1000)