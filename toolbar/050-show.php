<a
  title="<?= $wire->_('Show toolbar on/off') ?>"
  uk-tooltip
  data-toggle="show"
  data-persist
  data-instant
  class='on'>
  <svg class='visible-off' xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 24 24"><!-- Icon from Tabler Icons by Paweł Kuna - https://github.com/tabler/tabler-icons/blob/master/LICENSE -->
  ...
  <svg class='visible-on' xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 24 24"><!-- Icon from Tabler Icons by Paweł Kuna - https://github.com/tabler/tabler-icons/blob/master/LICENSE -->
